/*
 ...
 Source Schema         : ubigeo_peru

 Target Server Type    : MySQL
 Target Server Version : 80015
 File Encoding         : 65001

 Date: 06/05/2019 13:54:14
*/
...
-- Records of alumno
-- ----------------------------
INSERT INTO `alumno` VALUES (1, '755757', 'garcia', 'david', '7557575', 'totorita', 3, 2, 2, 'm');
INSERT INTO `alumno` VALUES (2, '4555757', 'ramos', 'Alfredo', '75575', 'totorita', 2, 2, 4, 'm');
INSERT INTO `alumno` VALUES (3, '75575', 'sanches', 'Aaron', '7414141', 'totorita', 3, 4, 2, 'm');
INSERT INTO `alumno` VALUES (4, '7575', 'flores', 'Omar', '417141', 'totorita', 2, 1, 1, 'm');
INSERT INTO `alumno` VALUES (5, '78945665', 'balabarca', 'Juan', '4141421', 'totorita', 2, 2, 1, 'm');
INSERT INTO `alumno` VALUES (6, '7895414', 'dueñas', 'Pedro', '142424', 'totorita', 2, 3, 1, 'm');
INSERT INTO `alumno` VALUES (7, '74128458', 'espinoza', 'Alfonso', '424242', 'totorita', 2, 2, 1, 'm');
INSERT INTO `alumno` VALUES (8, '78963511', 'chavez', 'Luis', '24242', 'alamos', 2, 1, 2, 'm');
INSERT INTO `alumno` VALUES (9, '757514524', 'ttito', 'Jorge', '7575454', 'totorita', 2, 1, 1, 'm');
INSERT INTO `alumno` VALUES (10, '12754475', 'ruiz', 'Maximo', '57575', 'totorita', 2, 2, 2, 'm');
...
delimiter ;;
CREATE PROCEDURE `sp_insertar_alumno`(IN `dni` VARCHAR(50), IN `ape` VARCHAR(50), IN `nom` VARCHAR(50), IN `tel` VARCHAR(50), IN `dir` VARCHAR(50), IN `depar` INT, IN `prov` INT, IN `dis` INT, IN `sex` VARCHAR(50))
BEGIN
insert INTO alumno values(null,dni,ape,nom,tel,dir,depar,prov,dis,sex);
